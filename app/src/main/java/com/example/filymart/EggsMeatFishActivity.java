...
public class EggsMeatFishActivity extends AppCompatActivity {
...
// finally change the color
    ...
    class EggsMeatFish extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EggsMeatFishActivity.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            adapter = new ProductsAdapterEmf(EggsMeatFishActivity.this, productList);
