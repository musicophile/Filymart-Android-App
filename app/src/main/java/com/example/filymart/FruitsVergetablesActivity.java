...
public class FruitsVergetablesActivity extends AppCompatActivity {
...
// finally change the color
    ...
    class FruitsVergetables extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(FruitsVergetablesActivity.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            adapter = new ProductsAdapterFv(FruitsVergetablesActivity.this, productList);
