...
public class ProductsAdapterSearched extends RecyclerView.Adapter<ProductsAdapterSearched.MyViewHolder> {

    private SearchedActivity mContext;
    ...
    public ProductsAdapterSearched(SearchedActivity mContext, List<Product> productList) {
