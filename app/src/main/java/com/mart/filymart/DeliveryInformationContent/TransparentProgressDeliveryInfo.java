...
public class TransparentProgressDeliveryInfo extends Dialog {

    private ImageView iv;

    public TransparentProgressDeliveryInfo(DeliveryInformationActivity context, int resourceIdOfImage) {
