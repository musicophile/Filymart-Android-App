...
public class ProductsAdapterFgo extends RecyclerView.Adapter<ProductsAdapterFgo.MyViewHolder> {

    private FoodGrainOilActivity mContext;
    ...
    public ProductsAdapterFgo(FoodGrainOilActivity mContext, List<ProductModel> productList) {
