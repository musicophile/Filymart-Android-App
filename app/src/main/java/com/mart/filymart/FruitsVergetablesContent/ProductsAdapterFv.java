...
public class ProductsAdapterFv extends RecyclerView.Adapter<ProductsAdapterFv.MyViewHolder> {

    private FruitsVergetablesActivity mContext;
    ...
    public ProductsAdapterFv(FruitsVergetablesActivity mContext, List<ProductModel> productList) {
