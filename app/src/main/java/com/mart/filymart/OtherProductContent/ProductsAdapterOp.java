...
public class ProductsAdapterOp extends RecyclerView.Adapter<ProductsAdapterOp.MyViewHolder> {

    private OtherProductsActivity mContext;
    ...
    public ProductsAdapterOp(OtherProductsActivity mContext, List<ProductModel> productList) {
