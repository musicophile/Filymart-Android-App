...
public class TransparentProgressDialogActivity extends Dialog {

    private ImageView iv;

    public TransparentProgressDialogActivity(ProductDetailsContents context, int resourceIdOfImage) {
