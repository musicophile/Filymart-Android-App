...
public class AppConfig {
    ...
    public static String URL_CHANGEUSERINFO = "http://www.filymart.com/mobileChangeUserInfo";

    // Server user register url
    public static String URL_REGISTER = "http://www.filymart.com/mobileRegisterUser";

    public static String URL_ORDER = "http://www.filymart.com/mobileOrder";

    public static String URL_ADDRESS = "http://filymart.com/mobile-address";

    public static String URL_SEARCH = "http://filymart.com/searchdataMobile";
    ...
    public static String URL_DATAFORPAYMENT = "http://www.filymart.com/mobileAllUserData";
}
